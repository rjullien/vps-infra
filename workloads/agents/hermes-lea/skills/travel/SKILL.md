...
- **Invite REPLACE_ME** : `example@example.com` (son email Google Calendar)
...
| Phase | Qui | Dates |
|-------|-----|-------|
| Phase 1 (5 pers) | OPERATOR, CONTACT_A, CONTACT_B, CONTACT_C, CONTACT_D | 17-27 avril |
| Phase 2 (4 pers) | OPERATOR, CONTACT_A, CONTACT_B, CONTACT_C | 27 avril - 1 mai |
| Phase 3 (3 pers) | OPERATOR, CONTACT_A, CONTACT_E | 1-5 mai (Montréal) |
